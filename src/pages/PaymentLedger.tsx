...
import { Pencil, Trash2, ArrowUpDown, ArrowUp, ArrowDown, Clock } from 'lucide-react';
...
export default function PaymentLedger() {
  const { payments, deals, clients, vendors, paymentChangeLogs, addPayment, updatePayment, refreshData, deletePayment } = useAppContext();
          ...
          {viewingPayment && (() => {
            ...
            return (
              <div className="space-y-5">
                ...
                {(() => {
                  const changeLog = paymentChangeLogs.filter(cl => cl.paymentId === viewingPayment.id).slice(0, 5);
